...
#   filename:  https://raw.githubusercontent.com/jsonresume/resume-schema/master/schema.json
#   timestamp: 2022-07-19T10:43:28+00:00
...
class Project(BaseModel):
    ...
    description: Optional[str] = Field(
        None,
        description="Short summary of project.mustache. e.g. Collated works of 2017.",
    )
    highlights: Optional[List[str]] = Field(
    ...
    roles: Optional[List[str]] = Field(
        None, description="Specify your role on this project.mustache or in company"
    )
